...
[cA1,cH1,cV1,cD1]=dwt2(double(Im1),wtype);
[cA2,cH2,cV2,cD2]=dwt2(double(Im2),wtype);
[r,c]=size(cA1);
cA = zeros(r,c);
cH = zeros(r,c);
cV = zeros(r,c);
